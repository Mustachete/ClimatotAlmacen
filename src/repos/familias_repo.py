...
def get_by_id(familia_id: int) -> Optional[Dict[str, Any]]:
    ...
    sql = "SELECT id, nombre FROM familias WHERE id = ?"
...
def verificar_articulos(familia_id: int) -> bool:
    ...
    sql = "SELECT COUNT(*) as count FROM articulos WHERE familia_id = ?"
