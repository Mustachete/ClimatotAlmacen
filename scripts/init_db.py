...
# Ahora las rutas son relativas a la raíz del proyecto
...
def main():
    ...
    if not SCHEMA.exists():
        print(f"\n❌ ERROR: No se encuentra el archivo schema.sql")
        print(f"   Buscado en: {SCHEMA}")
        print(f"   Verifica que el archivo exista en la carpeta db/")
        return
